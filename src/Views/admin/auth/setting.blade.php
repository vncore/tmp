                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                       ...
                                       <span class="input-group-btn">
                                        ...
                                        @endif
                                    <div id="preview_avatar" class="img_holder"><img src="{{ vc_file(old('avatar',$user['avatar']??'')) }}"></div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        @else
                                            @if ($user)
                                                <span class="form-text">
                                                    <i class="fa fa-info-circle"></i> {{ vc_language_render('admin.user.keep_password') }}
                                                 </span>
                                            @endif
                                        @endif
                                </div>
...
{{-- select permission --}}
        ...
        @endphp
                                <label for="permission" class="col-sm-2  control-label">{{ vc_language_render('admin.user.select_permission') }}</label>
                                <div class="col-sm-8">
