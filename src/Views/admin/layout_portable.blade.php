...
{{-- <!-- ChartJS -->
<script src="{{ vncore_file('admin/LTE/plugins/chart.js/Chart.min.js')}}"></script> --}}
<!-- JQVMap -->
...
<!-- daterangepicker -->
{{-- <script src="{{ vncore_file('admin/LTE/plugins/moment/moment.min.js')}}"></script>
<script src="{{ vncore_file('admin/LTE/plugins/daterangepicker/daterangepicker.js')}}"></script> --}}
<!-- Tempusdominus Bootstrap 4 -->
{{-- <script src="{{ vncore_file('admin/LTE/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js')}}"></script> --}}
<!-- Summernote -->
