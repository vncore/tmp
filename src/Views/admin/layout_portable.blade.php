...
{{-- <!-- ChartJS -->
<script src="{{ vc_file('admin/LTE/plugins/chart.js/Chart.min.js')}}"></script> --}}
<!-- JQVMap -->
...
<!-- daterangepicker -->
{{-- <script src="{{ vc_file('admin/LTE/plugins/moment/moment.min.js')}}"></script>
<script src="{{ vc_file('admin/LTE/plugins/daterangepicker/daterangepicker.js')}}"></script> --}}
<!-- Tempusdominus Bootstrap 4 -->
{{-- <script src="{{ vc_file('admin/LTE/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js')}}"></script> --}}
<!-- Summernote -->
