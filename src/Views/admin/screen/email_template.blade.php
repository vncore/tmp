                ...
                <div class="card-header with-border">
                    ...
                    <div class="card-tools">
                        <div class="btn-group float-right mr-5">
                            <a href="{{ vncore_route_admin('admin_email_template.index') }}" class="btn  btn-flat btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs"> {{ vncore_language_render('admin.back_list') }}</span></a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
...
@push('styles')
<link rel="stylesheet" href="{{ vncore_file('vncore-static/plugin/mirror/doc/docs.css')}}">
<link rel="stylesheet" href="{{ vncore_file('vncore-static/plugin/mirror/lib/codemirror.css')}}">
@endpush

@push('scripts')
<script src="{{ vncore_file('vncore-static/plugin/mirror/lib/codemirror.js')}}"></script>
<script src="{{ vncore_file('vncore-static/plugin/mirror/mode/javascript/javascript.js')}}"></script>
<script src="{{ vncore_file('vncore-static/plugin/mirror/mode/css/css.js')}}"></script>
<script src="{{ vncore_file('vncore-static/plugin/mirror/mode/htmlmixed/htmlmixed.js')}}"></script>
<script>
