...
@push('styles')
<!-- Ediable -->
<link rel="stylesheet" href="{{ vncore_file('admin/plugin/nestable/jquery.nestable.min.css')}}">
<link rel="stylesheet" href="{{ vncore_file('admin/plugin/iconpicker/fontawesome-iconpicker.min.css')}}">
@endpush

@push('scripts')
<!-- Ediable -->

<script src="{{ vncore_file('admin/plugin/nestable/jquery.nestable.min.js')}}"></script>
<script src="{{ vncore_file('admin/plugin/iconpicker/fontawesome-iconpicker.min.js')}}"></script>
