                ...
                <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main"  enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-group row {{ $errors->has('position') ? ' text-red' : '' }}">
                                ...
                                <span style="cursor: pointer;" onclick="imagedemo('https://static.vncore.org/file/block-template.jpg');"><i class="fa fa-question-circle" aria-hidden="true"></i></span>
                            </div>
                            ...
                            <div class="form-group row {{ $errors->has('text') ? ' text-red' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    @elseif ($dataType =='view')
                                        ...
                                        <span class="form-text"><i class="fa fa-info-circle"></i> {{ vncore_language_render('admin.store_block.helper_view',['template' => vncore_store('template', $storeId)]) }}</span>
                                    @else
