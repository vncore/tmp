                ...
                <div class="card-header with-border">
                    ...
                    <div class="card-tools">
                        <div class="btn-group float-right mr-5">
                            <a href="{{ vncore_route_admin('admin_store_link.index') }}" class="btn  btn-flat btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs"> {{ vncore_language_render('admin.back_list') }}</span></a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                            ...
                            <div class="form-group row {{ $errors->has('group') ? ' text-red' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group-append">
                                        <a href="{{ vncore_route_admin('admin_store_link_group.index') }}" class="btn  btn-flat" title="New">
...
@if (vncore_check_multi_shop_installed())
                            ...
                            @php
                            $listStore = [];
                            if (function_exists('vncore_get_list_store_of_link_detail')) {
                                $oldData = vncore_get_list_store_of_link_detail($link['id'] ?? '');
                            } else {
                                $oldData = null;
                            }
