@php
    $totalOrder = \Vncore\Core\Admin\Models\AdminOrder::count();
    $styleStatus = \Vncore\Core\Admin\Models\AdminOrder::$mapStyleStatus;
@endphp
@if ($totalOrder)
@php
    $arrStatus = \Vncore\Core\Front\Models\ShopOrderStatus::pluck('name','id')->all();
    $groupOrder = (new \Vncore\Core\Front\Models\ShopOrder)->all()->groupBy('status');
@endphp
    <li id="summary">
    <ul>
