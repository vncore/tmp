...
class DataStoreSeeder extends Seeder
{
    ...
    public function dataConfig($storeId) {
        $dataConfig = [
            ...
            ['group' => '','code' => 'admin_custom_config','key' => 'facebook_url','value' => 'https://www.facebook.com/Vncore.Ecommerce/','sort' => '0','detail' => 'admin.admin_custom_config.facebook_url','store_id' => $storeId],
            ['group' => '','code' => 'admin_custom_config','key' => 'fanpage_url','value' => 'https://www.facebook.com/groups/vncore.opensource','sort' => '0','detail' => 'admin.admin_custom_config.fanpage_url','store_id' => $storeId],
            ['group' => '','code' => 'admin_custom_config','key' => 'twitter_url','value' => 'https://twitter.com/ecommercevncore','sort' => '0','detail' => 'admin.admin_custom_config.twitter_url','store_id' => $storeId],
