...
class AdminPluginsController extends RootAdminController
{
    ...
    public function uninstall()
    {
        ...
        if (!$onlyRemoveData) {
            File::deleteDirectory(app_path('Vncore/Plugins/'.$key));
            ...
            if ($unzip) {
                ...
                if ($checkConfig) {
                    ...
                    if (!vncore_plugin_compatibility_check($vncoreVersion)) {
                        ...
                        return redirect()->back()->with('error', vncore_language_render('admin.plugin.not_compatible', ['version' => $vncoreVersion, 'vncore_version' => config('vncore.core')]));
                    }
